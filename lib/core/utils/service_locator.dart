...
Future<void> initDependencies() async {
  ...
  sl.registerLazySingleton<FlutterSoundPlayer>(() => FlutterSoundPlayer());
  ...
  sl.registerLazySingleton<SoundAroundDataSource>(() => SoundAroundDataSourceImpl(sl(), sl()));
  sl.registerLazySingleton<SoundAroundRepository>(() => SoundAroundRepositoryImpl(sl()));
